...
## 🔍 Required Configurations for iPhone/Safari Google Login
...
**Required Settings:**
- ✅ Status: **Enabled**
- ✅ Project public-facing name: `MyWineMemory`
- ✅ Project support email: Your email
- ✅ Web SDK configuration: Expanded and verified
...
**Location:** Firebase Console → Hosting → Domains
...
**Common Mistake:**
```bash
# ❌ WRONG - causes third-party cookie issues
